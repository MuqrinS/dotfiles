...
" deleting goes into the black hole instead
nnoremap d "_d
...
" Launch NERDTree without the help at the top and show hidden files
...
map <c-a> <esc>:w<cr>:Silent php-cs-fixer fix %:p --level=symfony<cr>
